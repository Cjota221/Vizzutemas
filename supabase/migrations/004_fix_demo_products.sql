-- =====================================================
-- FIX: Recriar tabelas demo_products e product_templates
-- =====================================================

-- Deletar tabelas existentes (se houver problemas)
DROP TABLE IF EXISTS demo_products CASCADE;
DROP TABLE IF EXISTS product_templates CASCADE;

-- Recriar tabela demo_products
...
-- Recriar tabela product_templates
...
-- Produtos template (Calçados Femininos)
